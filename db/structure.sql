...
CREATE TABLE public.tag_destinations (
    ...
    created_at timestamp without time zone DEFAULT '2024-03-20 09:54:48.008873'::timestamp without time zone,
    updated_at timestamp without time zone DEFAULT '2024-03-20 09:54:48.008873'::timestamp without time zone,
    id bigint NOT NULL
);
...
CREATE TABLE public.tag_plannings (
    planning_id integer NOT NULL,
    tag_id integer NOT NULL,
    created_at timestamp without time zone DEFAULT '2024-03-20 09:54:48.012167'::timestamp without time zone,
    updated_at timestamp without time zone DEFAULT '2024-03-20 09:54:48.012167'::timestamp without time zone,
    id bigint NOT NULL
);
...
CREATE TABLE public.tag_vehicle_usages (
    vehicle_usage_id integer,
    tag_id integer,
    created_at timestamp(6) without time zone DEFAULT '2024-10-10 13:46:07.978064'::timestamp without time zone NOT NULL,
    updated_at timestamp(6) without time zone DEFAULT '2024-10-10 13:46:07.978064'::timestamp without time zone NOT NULL,
    id bigint NOT NULL
);
...
CREATE TABLE public.tag_visits (
    visit_id integer NOT NULL,
    tag_id integer NOT NULL,
    created_at timestamp without time zone DEFAULT '2024-03-20 09:54:48.01388'::timestamp without time zone,
    updated_at timestamp without time zone DEFAULT '2024-03-20 09:54:48.01388'::timestamp without time zone,
    id bigint NOT NULL
);
