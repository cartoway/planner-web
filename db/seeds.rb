...
Visit.create!(ref: 'v1', quantities: {customer.deliverable_units[0].id => 1}, destination: Destination.create!(name: "l1", street: "Boulevard de Grenelle", postalcode: "75015", city: "Paris", lat: 48.84137, lng: 2.3003, customer: customer))
