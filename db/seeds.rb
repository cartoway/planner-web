...
mapnik_fr = Layer.create!(source: "osm", name: "Mapnik-fr", url: "https://a.tile.openstreetmap.fr/osmfr/{z}/{x}/{y}.png", attribution: "Tiles by OpenStreetMap-France")
mapnik = Layer.create!(source: "osm", name: "Mapnik", url: "https://tile.openstreetmap.org/{z}/{x}/{y}.png", attribution: "Tiles by OpenStreetMap")
stamen_bw = Layer.create!(source: "osm", name: "Stamen B&W", name_locale: {fr: "Stamen N&B"}, url: "https://stamen-tiles-{s}.a.ssl.fastly.net/toner-lite/{z}/{x}/{y}.png", attribution: "Tiles by Stamen Design")
here_layer = Layer.create!(source: "here", name: "Here", url: "https://maps.hereapi.com/v3/base/mc/{z}/{x}/{y}/png?style=logistics.day&apiKey=#{ENV['HERE_MAP_APIKEY']}", attribution: "Here")
...
Visit.create!(ref: 'v1', deliveries: {unit.id => 1}, destination: Destination.create!(name: "l1", street: "Boulevard de Grenelle", postalcode: "75015", city: "Paris", lat: 48.84137, lng: 2.3003, customer: customer))
...
Visit.create!(ref: 'v4-1', deliveries: {unit.id => 0.5}, destination: destination_4, tags: [frigo])
Visit.create!(ref: 'v4-2', deliveries: {unit.id => 0.5}, destination: destination_4)
