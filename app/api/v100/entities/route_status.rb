class V100::Entities::RouteStatus < Grape::Entity
  ...
  expose(:arrival_eta_formated, documentation: { type: DateTime, desc: 'Estimated time of arrival from remote device.' }) { |route| route.stop_route_data&.eta && I18n.l(route.stop_route_data.eta, format: :hour_minute) }
