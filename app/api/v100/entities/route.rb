class V100::Entities::Route < V100::Entities::RouteProperties
  ...
  expose(:departure_eta, documentation: { type: DateTime, desc: 'Estimated time of departure from remote device for start store.' }) { |route| route.start_route_data&.eta }
  ...
  expose(:arrival_eta, documentation: { type: DateTime, desc: 'Estimated time of arrival from remote device for stop store.' }) { |route| route.stop_route_data&.eta }
