...
class V01::VehicleUsageSets < Grape::API
  ...
  helpers do
    ...
    def vehicle_usage_set_params
      ...
      p = p.permit(:name, :cost_distance, :cost_fixed, :cost_time, :time_window_start, :time_window_end, :store_start_id, :store_stop_id, :service_time_start, :service_time_end, :work_time, :rest_start, :rest_stop, :rest_duration, :store_rest_id, :max_distance, :max_ride_distance, :max_ride_duration)
      p
    end
  end
