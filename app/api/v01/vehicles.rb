...
class V01::Vehicles < Grape::API
  ...
  helpers do
    ...
    def vehicle_usage_params
      ...
      p.permit(:cost_distance, :cost_fixed, :cost_time, :time_window_start, :time_window_end, :store_start_id, :store_stop_id, :store_rest_id, :rest_start, :rest_stop, :rest_duration, :rest_lapse, tag_ids: [])
    end
