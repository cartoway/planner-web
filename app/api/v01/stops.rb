      ...
      resource :routes do
        ...
        segment '/:route_id' do
          ...
          resource :stops do
            ...
            get ':id' do
              s = current_customer.plannings.where(ParseIdsRefs.where_clause([params[:planning_id]])).first!.routes.where(ParseIdsRefs.where_clause([params[:route_id]], table_name: 'routes')).first!.stops.with_attached_photos.with_attached_signature.where(id: params[:id]).first!
