  ...
  def self.status_codes
    {
      ...
      code_304: { code: 304, message: 'Not modified.', model: V2::Entities::Status304 },
      code_400: { code: 400, message: 'Bad request.', model: V2::Entities::Status400 },
      code_401: { code: 401, message: 'Unauthorized.', model: V2::Entities::Status401 },
      code_402: { code: 402, message: 'Subscription error.', model: V2::Entities::Status402 },
      code_403: { code: 403, message: 'Forbidden.', model: V2::Entities::Status403 },
      code_404: { code: 404, message: 'Not found.', model: V2::Entities::Status404 },
      code_405: { code: 405, message: 'Method not allowed.', model: V2::Entities::Status405 },
      code_409: { code: 409, message: 'Conflict.', model: V2::Entities::Status409 },
      code_422: { code: 422, message: 'Unprocessable entity.', model: V2::Entities::Status422 },
      code_500: { code: 500, message: 'Internal servor error.', model: V2::Entities::Status500 }
    }
  end
