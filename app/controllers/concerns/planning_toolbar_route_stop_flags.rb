...
# Maps route and stop toolbar segment permissions onto @manage_planning for the planning UI.
module PlanningToolbarRouteStopFlags
  ...
  def apply_route_toolbar_operation_flags!
    ...
    @manage_planning[:manage_route_lock] = route_op_visible.call('lock')
    @manage_planning[:disable_route_lock] = route_op_disabled.call('lock')
    ...
    @manage_planning[:disable_store_form] = store_form_visible && !store_form_usable
