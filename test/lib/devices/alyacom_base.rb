module AlyacomBase
  ...
  def set_route
    ...
    @route.route_data.update! end: @route.start + 5.hours
            ...
            names.each do |name|
              case name
                when :staff, :users, :planning
                  ...
                  url = [URI.parse(Planner::Application.config.devices.alyacom.api_url), @customer.devices[:alyacom][:association], name.to_s].join "/"
