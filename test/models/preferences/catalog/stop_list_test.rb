...
class Preferences::Catalog::StopListTest < ActiveSupport::TestCase
  ...
  test 'field_value visit_duration falls back to legacy duration key' do
    stop = { 'visits' => true, 'duration' => '00:06:00' }
    assert_equal '00:06:00', Preferences::Catalog::StopList.field_value(stop, 'visit_duration')
  end
