...
class ZonesControllerTest < ActionController::TestCase
  ...
  test 'should get show in excel' do
    ...
    assert_equal "b;destination_one;Rue des Lilas;MyString;33200;Bordeau;;49.1857;-0.3735;;;;MyString;MyString;\"\";;zone_one;\"\";b;00:05:33;10:00;11:00;;;4;;tag1;neutre;hidden on mobile;visible on mobile\r".encode("iso-8859-1"), response.body.split("\n").find{ |l| l.start_with? 'b;destination_one' }
  end
end
