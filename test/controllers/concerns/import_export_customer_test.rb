                            ...
                            assert_difference "Route.count", 6 do
                              assert_difference "Stop.count", 8 do
                                assert_difference "User.count", 3 do
                                  c = ImportExportCustomer.import(customer_data_file, { profile_id: profile_id, router_id: router_id, layer_id: layer_id, reseller_id: reseller_id, role_id: import_role.id })
