...
const LOOKBOOK_PREVIEWS: { path: string; name: string }[] = [
  ...
  { path: 'design_system/forms/filtered_search', name: 'forms-filtered_search' },
  { path: 'design_system/forms/validation', name: 'forms-validation' },
  { path: 'design_system/forms/range_inputs', name: 'forms-range_inputs' },
  ...
  { path: 'design_system/overlays/searchable_checklist_dropdown', name: 'overlays-searchable_checklist_dropdown' },
